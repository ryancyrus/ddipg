	...
	<div class="row">
		<div class="col-md-7">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<ul>
						...
						<li><a href="#">Computer Science and Engineering</li>
						<li><a href="#">Electrical Engineering</li>
						<li><a href="#">Electronincs & Communications</li>
						<li><a href="#">Information Technology</li>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<h3>Results</h3>
					<p class="lead"><a href="/result">View Result</a></p>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<h3>Create Resume</h3>
					<ul>
						<li><a href="/cvmakr">Connect with LinkedIn</a></li>
					</ul>
