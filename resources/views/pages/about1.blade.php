...
<div class="container">
	...
	<div class="row">
		<div class="col-md-7">
			...
			<div class="row">
				<div class="col-md-3">
					...
					<br>
					<br>
					<img src="/history.jpg" class="img-responsive">
			...
			<div class="row">
				<div class="col-md-3">
					...
					<br>
					<br>
					<img src="/vision.jpg" class="img-responsive">
				</div>
				<div class="col-md-9">
					<h3>Vision</h3>
					<p class="lead">
			...
			<div class="row">
				<div class="col-md-3">
					...
					<br>
					<br>
					<img src="/offices.jpg" class="img-responsive">
				</div>
				<div class="col-md-9">
					<h3>Offices & Administration</h3>
					<p class="lead">
						The university is led by Governor of State, governed by a Executive Council, and supported by numerous offices.
						<ul class="lead">
							<li><a href="#">Overview</a></li>
							<li>University Governance</li>
							<li>Vice Chancellor</li>
							<li><a href="/administration">Administrative Offices</a></li>
			...
			<div class="row">
				<div class="col-md-3">
					...
					<br>
					<br>
					<img src="/laws.jpg" class="img-responsive">
				</div>
				<div class="col-md-9">
					<h3>Laws</h3>
					<p class="lead">
						...
						<h4><a href="/ord31.pdf"> View Ordinance 31</a></h4>
		...
		<div class="col-md-5">
			<div class="row">
				<img src="/acside.jpg" class="img-responsive">
				<br>
